...
func (f *finder) At(ctx context.Context, at, after int64) (infinity.Chunk, feeds.Index, feeds.Index, error) {
...
func (f *finder) common(ctx context.Context, at, after int64) (*epoch, infinity.Chunk, error) {
...
func (f *finder) at(ctx context.Context, at uint64, e *epoch, ch infinity.Chunk) (infinity.Chunk, error) {
...
func (f *asyncFinder) get(ctx context.Context, at int64, e *epoch) (infinity.Chunk, error) {
...
func (f *asyncFinder) At(ctx context.Context, at, after int64) (infinity.Chunk, feeds.Index, feeds.Index, error) {
...
// At looks up the version valid at time `at`
// after is a unix time hint of the latest known update
func (f *asyncFinder) asyncAt(ctx context.Context, at, after int64) (infinity.Chunk, error) {
	c := make(chan *result)
