...
type Lookup interface {
	At(ctx context.Context, at, after int64) (chunk infinity.Chunk, currentIndex, nextIndex Index, err error)
}
...
func Latest(ctx context.Context, l Lookup, after int64) (infinity.Chunk, error) {
...
func (f *Getter) Get(ctx context.Context, i Index) (infinity.Chunk, error) {
...
func FromChunk(ch infinity.Chunk) (uint64, []byte, error) {
...
func UpdatedAt(ch infinity.Chunk) (uint64, error) {
	d := ch.Data()
	if len(d) < 113 {
