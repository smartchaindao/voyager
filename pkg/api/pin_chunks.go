...
func (s *server) updatePinCount(ctx context.Context, reference infinity.Address, delta int) error {
	diff := delta
...
func (s *server) pinChunkAddressFn(ctx context.Context, reference infinity.Address) func(address infinity.Address) error {
	return func(address infinity.Address) error {
...
func (s *server) unpinChunkAddressFn(ctx context.Context, reference infinity.Address) func(address infinity.Address) error {
	return func(address infinity.Address) error {
