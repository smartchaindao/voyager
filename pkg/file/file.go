...
type Joiner interface {
	...
	IterateChunkAddresses(infinity.AddressIterFunc) error
...
// When EOF is received and splitting is done, the resulting Smart Chain Address is returned.
type Splitter interface {
	Split(ctx context.Context, dataIn io.ReadCloser, dataLength int64, toEncrypt bool) (addr infinity.Address, err error)
}
