...
var (
	dataWrites = [][]int{
		{infinity.ChunkSize - 2},                            // short
		{infinity.ChunkSize - 2, 4},                         // short, over
		{infinity.ChunkSize - 2, 4, infinity.ChunkSize - 6}, // short, over, short
		{infinity.ChunkSize - 2, 4, infinity.ChunkSize - 4}, // short, over, onononon
		{infinity.ChunkSize, 2, infinity.ChunkSize - 4},     // on, short, short
		{infinity.ChunkSize, 2, infinity.ChunkSize - 2},     // on, short, on
		{infinity.ChunkSize, 2, infinity.ChunkSize},         // on, short, over
		{infinity.ChunkSize, 2, infinity.ChunkSize - 2, 4},  // on, short, on, short
		{infinity.ChunkSize, infinity.ChunkSize},            // on, on
	}
)
...
func TestCopyBuffer(t *testing.T) {
	...
	dataSizes := []int{
		...
		64,
		1024,
		infinity.ChunkSize - 1,
		infinity.ChunkSize,
		infinity.ChunkSize + 1,
		infinity.ChunkSize * 2,
		infinity.ChunkSize*2 + 3,
		infinity.ChunkSize * 5,
		infinity.ChunkSize*5 + 3,
		infinity.ChunkSize * 17,
		infinity.ChunkSize*17 + 3,
	}
	...
	for _, tc := range testCases {
		t.Run(fmt.Sprintf("buf_%-4d/data_size_%d", tc.readBufferSize, tc.dataSize), func(t *testing.T) {
			...
			go func() {
				...
				buf := make([]byte, infinity.ChunkSize)
