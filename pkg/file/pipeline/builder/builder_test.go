...
func TestPartialWrites(t *testing.T) {
	...
	exp := infinity.MustParseHexAddress("92672a471f4419b255d7cb0cf313474a6f5856fb347c5ece85fb706d644b630f")
...
func TestEmpty(t *testing.T) {
	...
	exp := infinity.MustParseHexAddress("ffd70157e48063fc33c97a050f7f640233bf646cc98d9524c6b92bcf3ab56f83")
	if !bytes.Equal(exp.Bytes(), sum) {
		t.Fatalf("expected %s got %s", exp.String(), hex.EncodeToString(sum))
	}
}
...
goos: linux
goarch: amd64
pkg: github.com/yanhuangpai/voyager/pkg/file/pipeline/builder
BenchmarkPipeline
...
PASS
ok  	github.com/yanhuangpai/voyager/pkg/file/pipeline/builder	17.599s
*/
