...
import (
	...
	mock "github.com/yanhuangpai/voyager/pkg/file/pipeline/mock"
	"github.com/yanhuangpai/voyager/pkg/file/pipeline/store"
	"github.com/yanhuangpai/voyager/pkg/infinity"
	"github.com/yanhuangpai/voyager/pkg/storage"
	storer "github.com/yanhuangpai/voyager/pkg/storage/mock"
)
...
func TestStoreWriter(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		d, err := mockStore.Get(ctx, storage.ModeGetRequest, infinity.NewAddress(tc.ref))
		if err != nil {
			t.Fatal(err)
		}
