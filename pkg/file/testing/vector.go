...
var (
	...
	fileLengths     = []int{
		...
		64,                              // 4
		65,                              // 5
		infinity.ChunkSize,              // 6
		infinity.ChunkSize + 31,         // 7
		infinity.ChunkSize + 32,         // 8
		infinity.ChunkSize + 63,         // 9
		infinity.ChunkSize + 64,         // 10
		infinity.ChunkSize * 2,          // 11
		infinity.ChunkSize*2 + 32,       // 12
		infinity.ChunkSize * 128,        // 13
		infinity.ChunkSize*128 + 31,     // 14
		infinity.ChunkSize*128 + 32,     // 15
		infinity.ChunkSize*128 + 64,     // 16
		infinity.ChunkSize * 129,        // 17
		infinity.ChunkSize * 130,        // 18
		infinity.ChunkSize * 128 * 128,  // 19
		infinity.ChunkSize*128*128 + 32, // 20
	}
...
func GetVector(t *testing.T, idx int) ([]byte, infinity.Address) {
	t.Helper()
	...
	return data, infinity.MustParseHexAddress(fileExpectHashHex[idx])
}
