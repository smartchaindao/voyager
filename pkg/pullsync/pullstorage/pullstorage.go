...
type Storer interface {
	...
	// Get chunks.
	Get(ctx context.Context, mode storage.ModeGet, addrs ...infinity.Address) ([]infinity.Chunk, error)
	// Put chunks.
	Put(ctx context.Context, mode storage.ModePut, chs ...infinity.Chunk) error
	// Set chunks.
	Set(ctx context.Context, mode storage.ModeSet, addrs ...infinity.Address) error
	// Has chunks.
	Has(ctx context.Context, addr infinity.Address) (bool, error)
}
...
// Get chunks.
func (s *ps) Get(ctx context.Context, mode storage.ModeGet, addrs ...infinity.Address) ([]infinity.Chunk, error) {
	return s.Storer.GetMulti(ctx, mode, addrs...)
}

// Put chunks.
func (s *ps) Put(ctx context.Context, mode storage.ModePut, chs ...infinity.Chunk) error {
