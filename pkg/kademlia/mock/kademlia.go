...
type AddrTuple struct {
	Addr infinity.Address // the peer address
	PO   uint8            // the po
}
...
func (m *Mock) AddPeers(ctx context.Context, addr ...infinity.Address) error {
	panic("not implemented") // TODO: Implement
}

func (m *Mock) ClosestPeer(addr infinity.Address, skipPeers ...infinity.Address) (peerAddr infinity.Address, err error) {
	panic("not implemented") // TODO: Implement
}
...
func (m *Mock) Connected(_ context.Context, addr infinity.Address) error {
	m.mtx.Lock()
...
func (m *Mock) Disconnected(_ infinity.Address) {
	m.Trigger()
}
