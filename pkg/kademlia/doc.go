...
has disconnected from us (2) A peer has voyagern added to the list of
known peers (from discovery, debugapi, bootnode flag or just because it
was persisted in the address book and the node has voyagern restarted).

So the information has voyagern changed, and potentially upon disconnection,
...
For the rationale behind this please refer to the appropriate chapters in the book of Infinity.
...
in an ever-increasing size of Infinity, resulting in smaller areas of responsibility
for the nodes, maintaining a general upper bound of the assigned nominal
area of responsibility in terms of actual storage requirement. See book of Smart Chain for more details.
...
theorical upper bound has voyagern reached.
