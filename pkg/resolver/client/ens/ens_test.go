...
func TestResolve(t *testing.T) {
	...
	testInfinityAddr := infinity.MustParseHexAddress("aaabbbcc")
	...
	testCases := []struct {
		...
		{
			desc: "resolve does not prefix address with /infinity",
			resolveFn: func(*goens.Registry, common.Address, string) (string, error) {
				return testInfinityAddr.String(), nil
			},
			wantErr: ens.ErrInvalidContentHash,
		},
		{
			...
			resolveFn: func(*goens.Registry, common.Address, string) (string, error) {
				return ens.InfinityContentHashPrefix + testInfinityAddr.String(), nil
			},
			wantErr: ens.ErrInvalidContentHash,
		},
		{
