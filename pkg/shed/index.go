...
// Item holds fields relevant to Smart Chain Chunk data and metadata.
// All information required for Smart Chain storage and operations
// on that storage must be defined here.
// This structure is logically connected to Smart Chain storage,
