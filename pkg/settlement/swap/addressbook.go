...
type Addressbook interface {
	...
	Beneficiary(peer infinity.Address) (beneficiary common.Address, known bool, err error)
	// Chequebook returns the chequebook for the given peer.
	Chequebook(peer infinity.Address) (chequebookAddress common.Address, known bool, err error)
	// BeneficiaryPeer returns the peer for a beneficiary.
	BeneficiaryPeer(beneficiary common.Address) (peer infinity.Address, known bool, err error)
	// ChequebookPeer returns the peer for a beneficiary.
	ChequebookPeer(chequebook common.Address) (peer infinity.Address, known bool, err error)
	// PutBeneficiary stores the beneficiary for the given peer.
	PutBeneficiary(peer infinity.Address, beneficiary common.Address) error
	// PutChequebook stores the chequebook for the given peer.
	PutChequebook(peer infinity.Address, chequebook common.Address) error
}
...
// Beneficiary returns the beneficiary for the given peer.
func (a *addressbook) Beneficiary(peer infinity.Address) (beneficiary common.Address, known bool, err error) {
...
// BeneficiaryPeer returns the peer for a beneficiary.
func (a *addressbook) BeneficiaryPeer(beneficiary common.Address) (peer infinity.Address, known bool, err error) {
	err = a.store.Get(beneficiaryPeerKey(beneficiary), &peer)
	if err != nil {
		if err != storage.ErrNotFound {
			return infinity.Address{}, false, err
		}
		return infinity.Address{}, false, nil
	}
	return peer, true, nil
}

// Chequebook returns the chequebook for the given peer.
func (a *addressbook) Chequebook(peer infinity.Address) (chequebookAddress common.Address, known bool, err error) {
...
// ChequebookPeer returns the peer for a beneficiary.
func (a *addressbook) ChequebookPeer(chequebook common.Address) (peer infinity.Address, known bool, err error) {
...
// PutBeneficiary stores the beneficiary for the given peer.
func (a *addressbook) PutBeneficiary(peer infinity.Address, beneficiary common.Address) error {
...
// PutChequebook stores the chequebook for the given peer.
func (a *addressbook) PutChequebook(peer infinity.Address, chequebook common.Address) error {
...
func peerKey(peer infinity.Address) string {
...
func peerBeneficiaryKey(peer infinity.Address) string {
