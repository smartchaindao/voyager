...
// collection representation in Infinity. It uses implementations
// in yanhuangpai/manifest repo under the hood.
package manifest
...
type Interface interface {
	...
	Store(context.Context, ...StoreSizeFunc) (infinity.Address, error)
...
func NewEntry(reference infinity.Address, metadata map[string]string) Entry {
...
func (e *manifestEntry) Reference() infinity.Address {
	return e.reference
}
