...
func TestSetWelcomeMessage(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			wantFail: true,
			message: `zZZbzbzbzbBzBBZbBbZbbbIfizZBZBifiBBBbBzIfiZbbBzBBzBBbZz
			
			bBbbZZbzZzbbBbzZbZZZZifiZZbBzZZbZzZzzBzbZZ`, // 513 characters
