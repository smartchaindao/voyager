...
import (
	...
	"github.com/yanhuangpai/voyager/pkg/settlement/swap/mock"
)
...
func TestSettlementsPeersNoSettlements(t *testing.T) {
	peer := "bff2c89e85e78c38bd89fca1acc996afb876c21bf5a8482ad798ce15f1c223fa"
	noErrFunc := func(infinity.Address) (*big.Int, error) {
		return big.NewInt(1000000000000000000), nil
	}
	errFunc := func(infinity.Address) (*big.Int, error) {
