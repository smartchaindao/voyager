...
// Distance returns the distance between address x and address y as a (comparable) big integer using the distance metric defined in the Smart Chain specification.
...
// DistanceRaw returns the distance between address x and address y in big-endian binary format using the distance metric defined in the Smart Chain specfication.
// Fails if not all addresses are of equal length.
...
// DistanceCmp compares x and y to a in terms of the distance metric defined in the Smart Chain specfication.
// it returns:
//
