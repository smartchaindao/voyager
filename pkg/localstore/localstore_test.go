...
import (
	...
	chunktesting "github.com/yanhuangpai/voyager/pkg/storage/testing"
...
func chunkAddresses(chunks []infinity.Chunk) []infinity.Address {
	addrs := make([]infinity.Address, len(chunks))
...
func TestGenerateTestRandomChunk(t *testing.T) {
	...
	dataLen := len(c1.Data())
	if dataLen != infinity.ChunkSize+infinity.SpanSize {
		t.Errorf("first chunk data length %v, want %v", dataLen, infinity.ChunkSize)
	}
	...
	dataLen = len(c2.Data())
	if dataLen != infinity.ChunkSize+infinity.SpanSize {
		t.Errorf("second chunk data length %v, want %v", dataLen, infinity.ChunkSize)
	}
...
func newRetrieveIndexesTest(db *DB, chunk infinity.Chunk, storeTimestamp, accessTimestamp int64) func(t *testing.T) {
...
func newRetrieveIndexesTestWithAccess(db *DB, ch infinity.Chunk, storeTimestamp, accessTimestamp int64) func(t *testing.T) {
	return func(t *testing.T) {
		t.Helper()
...
func newPullIndexTest(db *DB, ch infinity.Chunk, binID uint64, wantError error) func(t *testing.T) {
	return func(t *testing.T) {
		t.Helper()
...
func newPushIndexTest(db *DB, ch infinity.Chunk, storeTimestamp int64, wantError error) func(t *testing.T) {
	return func(t *testing.T) {
		t.Helper()
...
func newGCIndexTest(db *DB, chunk infinity.Chunk, storeTimestamp, accessTimestamp int64, binID uint64, wantError error) func(t *testing.T) {
	return func(t *testing.T) {
		t.Helper()
...
func newPinIndexTest(db *DB, chunk infinity.Chunk, wantError error) func(t *testing.T) {
	return func(t *testing.T) {
		t.Helper()
