...
func peerBalanceKey(peer infinity.Address) string {
...
func peerSurplusBalanceKey(peer infinity.Address) string {
...
func balanceKeyPeer(key []byte) (infinity.Address, error) {
	k := string(key)
...
func surplusBalanceKeyPeer(key []byte) (infinity.Address, error) {
	k := string(key)
